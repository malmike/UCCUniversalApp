...
namespace UCCUniversalApp
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        SupervisorViewModel supViewModel = new SupervisorViewModel();

        //Task pushURITask;
        //string pushNotificationURI;

        private EmployeeCheckInDataContext context = new EmployeeCheckInDataContext();
        ...
        async protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (isNetwork)
            {
                ...
                if (appSettings.verifyRegistrationSettings())
                {
                    ...
                    sharedInformation.jsn = await userDetails.getDetails(webURI.getSupervisorDetails, sharedInformation.empData.EmpFn, null, null);
        ...
        {
            sharedInformation.userVariables = args.Content.ToString();
